...
public class Clase3 {
    ...
    public static void main(String[] args) {
        ...
        Book book2 = new Book("Sangre de campeòn", "Acción","¿?", 1, 93,"17/02/24","Federico Fernandez ","17/07/24");
        ...
        System.out.println(book2.getAmmount());
        System.out.println(book2.getId());
        System.out.println(book2.getLoanDate());
        System.out.println(book2.getUser());
        System.out.println(book2.getReturnDate());
